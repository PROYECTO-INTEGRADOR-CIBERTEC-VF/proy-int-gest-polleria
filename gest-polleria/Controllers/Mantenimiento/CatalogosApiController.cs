...
namespace gest_polleria.Controllers.Mantenimiento
{
    public class CatalogosApiController : Controller
    {
        ...
        public async Task<IActionResult> ListadoCategorias()
        {
            ...
            return View(lista); // Ahora devuelve la Vista correctamente
        }
        ...
        // --- Los demás métodos RegistrarUnidad y RegistrarRol se mantienen igual, 
        // pero asegúrate de que también devuelvan IActionResult ---
